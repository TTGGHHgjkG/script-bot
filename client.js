...
const { Function } = require('./system/functions')
...
const machine = (process.env.DATABASE_URL && /mongo/.test(process.env.DATABASE_URL)) ? MongoDB : (process.env.DATABASE_URL && /postgres/.test(process.env.DATABASE_URL)) ? PostgreSQL : new(require('./system/localdb'))(env.database)
...
client.on('ready', async () => {
   ...
   require('./system/config'), require('./system/baileys')(client.sock), require('./system/functions'), require('./system/scraper')
